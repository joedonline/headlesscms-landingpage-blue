            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                                <img src="<?php bloginfo( 'template_url' ); ?>/dist/images/logo.svg" alt="Blue logo">
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero">
                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">Portland taiyaki distillery artisan food truck</h1>
	                        <p class="hero-paragraph is-revealing">Meh tilde mustache hexagon before they sold out yuccie meggings keffiyeh, 3 wolf moon pour-over.</p>
	                        <p class="hero-cta mb-0 is-revealing">
								<a class="button button-primary button-shadow" href="#">Call to action</a>
							</p>
						</div>
                        ...
                        <div class="container-sm">
                            <ul class="list-reset mb-0">
                                <li class="is-revealing">
                                    <img src="<?php bloginfo( 'template_url' ); ?>/dist/images/facebook-logo.svg" alt="Facebook logo">
                                </li>
                                <li class="is-revealing">
                                    <img src="<?php bloginfo( 'template_url' ); ?>/dist/images/tinder-logo.svg" alt="Tinder logo">
                                </li>
                                <li class="is-revealing">
                                    <img src="<?php bloginfo( 'template_url' ); ?>/dist/images/airbnb-logo.svg" alt="Airbnb logo">
                                </li>
                                <li class="is-revealing">
                                    <img src="<?php bloginfo( 'template_url' ); ?>/dist/images/microsoft-logo.svg" alt="Microsoft logo">
                                </li>
								<li class="is-revealing">
									<img src="<?php bloginfo( 'template_url' ); ?>/dist/images/hubspot-logo.svg" alt="Hubspot logo">
								</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="features-inner section-inner has-top-divider">
						<div class="features-header text-center">
							<div class="container-sm">
								...
								<p class="section-paragraph mb-0">Vexillologist pok pok etsy, hexagon distillery kogi hashtag activated charcoal drinking vinegar godard tacos kombucha shaman microdosing helvetica.</p>
							</div>
						</div>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title">8-bit Farm-To-Table</h4>
                            ...
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title">Mustache Sriracha</h4>
                                    <p class="text-sm">often arouses curiosity due to its resemblance to classical latin</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title">Subway Tile</h4>
                                    <p class="text-sm">often arouses curiosity due to its resemblance to classical latin</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title">Thundercats</h4>
                                    <p class="text-sm">often arouses curiosity due to its resemblance to classical latin</p>
                                </div>
                            </div>
                        </div>
							...
							<ul class="tabs-links">
								<li class="is-revealing">
									<a href="#tab-1" class="tab-link is-active">
										<img src="<?php bloginfo( 'template_url' ); ?>/dist/images/tabs-icon-01.svg" alt="Tabs icon 01">
										<span class="h4 m-0">Amazing features</span>
									</a>
								</li>
								<li class="is-revealing">
									<a href="#tab-2" class="tab-link">
										<img src="<?php bloginfo( 'template_url' ); ?>/dist/images/tabs-icon-02.svg" alt="Tabs icon 02">
										<span class="h4 m-0">Endless possibilities</span>
									</a>
								</li>
								<li class="is-revealing">
									<a href="#tab-3" class="tab-link">
										<img src="<?php bloginfo( 'template_url' ); ?>/dist/images/tabs-icon-03.svg" alt="Tabs icon 03">
			...
			<section class="cta section">
				<div class="container">
					<div class="cta-inner section-inner is-revealing">
						<h3 class="section-title mt-0">Need help?</h3>
						<div class="cta-cta">
							<a class="button button-primary button-shadow" href="#">Call our customer service</a>
						</div>
					</div>
				</div>
			</section>
